...
namespace TransCarga
{
    class publico
    {
        ...
        private conClie generarepgrt(string rpt_grt)
        {
            ...
            rowcabeza.dptoRemit = row["Dpto_Rem"].ToString();   // row[""].ToString();    // tx_dptoRtt.Text;
            rowcabeza.provRemit = row["Prov_Rem"].ToString();    // tx_provRtt.Text;
            rowcabeza.distRemit = row["Dist_Rem"].ToString();    // tx_distRtt.Text;
            ...
            rowcabeza.distDestinat = row["Dist_Des"].ToString(); // tx_disDrio.Text;
            rowcabeza.provDestinat = row["Prov_Des"].ToString(); // tx_proDrio.Text;
            rowcabeza.dptoDestinat = row["Dpto_Des"].ToString(); // tx_dptoDrio.Text;

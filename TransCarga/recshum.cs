...
namespace TransCarga
{
    public partial class recshum : Form
    {
        ...
        static string nomtab = "recursosh";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (modo == "NUEVO")
            {
                ...
                {
                    iserror = "no";
                    string consulta = "insert into recursosh (rucpro,coment,tipo,status,placa,marca,modelo,confve,chasis,motor,autor1,soat,placAsoc," +
                    ...
                    if (conn.State == ConnectionState.Open)
                    {
                        ...
                        {
                            string actua = "update recursosh set placAsoc=@pla where placa=@pas";
            ...
            if (modo == "EDITAR")
            {
                ...
                {
                    iserror = "no";
                    string consulta = "update recursosh set " +
